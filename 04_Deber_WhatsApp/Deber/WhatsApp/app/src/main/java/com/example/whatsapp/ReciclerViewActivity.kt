...
class ReciclerViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listaUsuario.add(Usuario("Morales","Te espero","15/06/2019",1))
        listaUsuario.add(Usuario("Carillo","Ola :D","14/06/2019",2))
        listaUsuario.add(Usuario("Yoli","Ok bebe","13/06/2019",3))
        listaUsuario.add(Usuario("Cris","Ola wapa","12/06/2019",4))
        listaUsuario.add(Usuario("Jenny","Te echo de menos","11/06/2019",5))
        listaUsuario.add(Usuario("Annita","Donde estas?","10/06/2019",6))
        listaUsuario.add(Usuario("Turista","Que haces?","09/06/2019",8))
        listaUsuario.add(Usuario("Carli","https://www.canvas.com","07/06/2019",9))
        listaUsuario.add(Usuario("Danny",":D","06/06/2019",10))
